...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div>
                <h1 style="color:#888888">my<span style="color:#00d053">challenges</span></h1>
            </div>
        </div>
    </div>
                        ...
                        @foreach ($activeChallenges as $challenge)
                            <tr>
                                ...
                                @else
                                    ...
                                    <td>
                                        <p data-placement="top" data-toggle="tooltip" title="Delete">
                                            <button style="opacity: .2" class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete-{{ $challenge->id }}" >
                                                <span class="glyphicon glyphicon-trash"></span></button></p>
                                        <div class="modal fade" id="delete-{{ $challenge->id }}" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer ">
                                                        <form method="POST" action="{{ action('ChallengesController@destroy', $challenge->id) }}">
                                                            {{csrf_field()}}
                                                            {{method_field('DELETE')}}
